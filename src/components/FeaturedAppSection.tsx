      ...
      <div className="relative container mx-auto px-4 sm:px-6">
        ...
        >
            ...
            >
              <div className="relative mx-auto" style={{ maxWidth: "280px" }}>
                <button
                  ...
                  className="relative w-full bg-[#1a1a1a] rounded-[2.8rem] p-[3px] shadow-2xl ring-1 ring-white/5 focus:outline-none focus-visible:ring-2 focus-visible:ring-foreground/30"
                  type="button"
          ...
          {reviews && reviews.length > 0 && (
            <AppReviewsSection appName={appName} reviews={reviews} />
          )}
        </motion.div>
      </div>
    </section>
