          ...
          >
            ...
            <motion.div className="space-y-4" variants={fadeInUp}>
              ...
              <div className="pl-4 space-y-3 text-foreground/55 leading-relaxed">
                <p>
                  Convertit Pro is the full-featured, ad-free app for working
                  with audio and video on your phone. You can convert between
                  common formats, edit tags and metadata, and strip embedded
                  data from files when you want a cleaner copy. The free{" "}
                  <Link
            ...
            <motion.div className="space-y-4" variants={fadeInUp}>
              ...
              <div className="pl-4 space-y-3 text-foreground/55 leading-relaxed">
                <p>
                  ...
                  our own servers. There is no account system in Convertit Pro
                  that sends your identity back to us.
                </p>
                <p>
                  The app is built to work fully offline for its core features.
                  It does not need the internet to convert files or edit
                  metadata, and it does not send your files anywhere for
                  processing.
                </p>
                <p>
            ...
            <motion.div className="space-y-4" variants={fadeInUp}>
              ...
              <div className="pl-4 space-y-3 text-foreground/55 leading-relaxed">
                ...
                <ul className="list-disc pl-5 space-y-2">
                  ...
                  <li>
                    App settings such as theme and format choices you pick
                    inside the app
                  </li>
                  <li>
                    Short-lived temp files while a job runs. The app cleans
                    these up when it can
                  </li>
                </ul>
            ...
            <motion.div className="space-y-4" variants={fadeInUp}>
              ...
              <div className="pl-4 space-y-3 text-foreground/55 leading-relaxed">
                <p>
                  Convertit Pro is available through Google Play. When you buy
                  or subscribe inside the app, Google runs billing and may keep
                  ...
                  , not ours. We do not receive your full card number from
                  Google.
                </p>
                <p>
              ...
              <div className="pl-4 space-y-3 text-foreground/55 leading-relaxed">
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                    ...
                    scope follows what the system allows for audio (and video
                    when applicable).
                  </li>
                  <li>
                    <strong className="text-foreground">Notifications.</strong>{" "}
                    Optional progress and completion messages, including when
                  ...
                  <li>
                    ...
                    So a long conversion can finish even if you switch to
                    another app. This may use a foreground service where Android
                    requires it.
                  </li>
                </ul>
                <p className="text-sm text-foreground/45 mt-3">
            ...
            <motion.div className="space-y-4" variants={fadeInUp}>
              ...
              <div className="pl-4 space-y-3 text-foreground/55 leading-relaxed">
                <p>
                  ...
                  you choose to use Convertit Pro for converting music or any
                  other haram content, you take full personal responsibility for
                  such use. The developers of Convertit Pro bear no
                  responsibility for how the app is used.
                </p>
              </div>
            </motion.div>
